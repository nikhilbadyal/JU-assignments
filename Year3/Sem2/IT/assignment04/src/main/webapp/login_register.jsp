...
<div class="page-content">
    <div class="form-v4-content">
        <div class="form-left">
            ...
            <img src="images/shop-bag.png" alt="">
            <p class="text-1">Hello Dear, Welcome to the Apparel Store</p>
            ...
            <div class="form-left-last">
                <div class="tab-inner">
                    <input type="submit" name="account" class="account" value="New Member?"
                           onclick="openCity(event, 'sign-up')">

                </div>
                <div class="tab-inner">
                    <input type="submit" name="account" class="account" value="Have An Account"
                           onclick="openCity(event, 'sign-in')" id="defaultOpen">
                </div>
        ...
        <form class="form-detail" action="Register" method="post">
            <div class="tabcontent" id="sign-up">
                <%
                    ...
                    if (register_msg != null && register_msg.equals("Register Success"))
                        response.getWriter().println("<font color=green size=4px>" + register_msg + "</font>");

                    else if (register_msg != null && register_msg.equals("Registered Fails"))
                        response.getWriter().println("<font color=red size=4px>" + register_msg + "</font>");
                %>
                <h2>REGISTER FORM</h2>
            ...
            <div class="tabcontent" id="sign-in">
                ...
                <div class="error-msg">
                    <%
                        ...
                        if (login_msg != null)
                            response.getWriter().println("<font color=red size=4px>" + login_msg + "</font>");
                    %>
