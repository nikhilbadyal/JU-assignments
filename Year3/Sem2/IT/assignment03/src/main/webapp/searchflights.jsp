...
<html>
    <head>
        ...
        function validate_and_submit(){
            const src = document.getElementById("search_src").value;
            const dest = document.getElementById("search_dest").value;
    ...
    <body>
        <style>
            .section{
                background-image: url("https://media0.giphy.com/media/KAuvuVawOKqnNgjXfx/giphy.gif");
            ...
            <div class="row">
               ...
               <div class="col s3">
                ...
                <div class="input-field">
                    <label for="search_src"></label><input class="white grey-text" placeholder="Kolkata" type="text" name="search_src" id="search_src">
                </div>
              </div>
               <div class="col s3">
                <h6>Journey Ends</h6>
                <div class="input-field">
                    <label for="search_dest"></label><input class="white grey-text" placeholder="Mumbai" type="text" name="search_dest" id="search_dest">
                </div>
              </div>
