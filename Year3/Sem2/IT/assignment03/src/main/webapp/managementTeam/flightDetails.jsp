...
<%@ page import="com.nikhil.assignment03.admin.model.Admin" %>
...
<body>
  ...
  <div class="row">
	...
	<table class="centered">
        ...
        <tbody>
        <% 
        String dburl = "jdbc:mysql://localhost:3306/traveldatabase";
        ...
        String sql = "select * from traveldatabase.flight";
