...
<div class="slider">
    <ul class="slides">
        <li>
            <img src="images/a1.jpg" alt=""> <!-- random image -->
        ...
        <li>
            <img src="images/a2.jpg" alt=""> <!-- random image -->
        ...
        <li>
            <img src="images/a3.jpg" alt=""> <!-- random image -->
        ...
        <li>
            <img src="images/a4.jpg" alt=""> <!-- random image -->
            <div class="caption left-align">
        ...
        <li>
            <img src="images/a5.jpg" alt=""> <!-- random image -->
            <div class="caption right-align">
                <h3>First Class!</h3>
...
<div class="row">
    ...
    <%
        String sql;
        if (srcQuery != null && destQuery != null && dateQuery != null) {
            sql = "select * from traveldatabase.flight where src like '%" + srcQuery + "%' and dest like '%" + destQuery + "%' and dept_date like '%" + dateQuery + "%' ";
        } else {
            sql = "select * from traveldatabase.flight where special_offer !=''";
        }
        try {
    ...
    <div class="column">
        <div class="card">
            <div>
                <p class="to orange-text"><%=res.getString("src") %>
                </p>
                <img class="ridge" src="images/travel.jpg">
                <p class="from green-text"><%=res.getString("dest") %>
                </p>
            </div>
            ...
            <div class="bottom-right">
                ...
                <img src="images/special-offer.jpg">
            ...
            <div class="card-body">
                <h5 class="card-title"><%=res.getString("company") %>
                </h5>
            </div>
            ...
            <table>
                ...
                <tr>
                    <th>Flight No. :-</th>
                    <td><%=res.getString("fno") %>
                    </td>
                </tr>

                <tr>
                    <th>Source :-</th>
                    <td><%=res.getString("src") %>
                    </td>
                </tr>

                <tr>
                    <th>Destination :-</th>
                    <td><%=res.getString("dest") %>
                    </td>
                </tr>

                <tr>
                    <th>Departure Date :-</th>
                    <td><%=res.getString("dept_date") %>
                    </td>
                </tr>

                <tr>
                    <th>Departure Time:-</th>
                    <td><%=res.getString("dept_time") %>
                    </td>
                </tr>

                <tr>
                    <th>Capacity :-</th>
                    <td><%=res.getInt("capacity") %>
                    </td>
                </tr>

                <tr>
                    <th>Legs :-</th>
                    <td><%=res.getInt("seat_left") %>
                    </td>
                </tr>

                <tr>
                    <th>MRP :-</th>
                    <td><i class="fa fa-rupee"></i> <%=res.getInt("price") %>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><%=res.getString("special_offer")%>
                    </td>
                ...
                <tr>
                    ...
                    <td class="special-time"><%=res.getString("special_limit") %>
                    </td>
                </tr>
                <%} %>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col l4 offset-l2 s12">
                ...
                <ul class="icons">
                    <li><a class="fa fa-twitter grey-text text-lighten-3" href="https://github.com/ProblematicDude"></a></li>
                    <li><a class="fa fa-facebook grey-text text-lighten-3" href="https://github.com/ProblematicDude"></a></li>
                    <li><a class="fa fa-instagram grey-text text-lighten-3" href="https://github.com/ProblematicDude"></a></li>
                    <li><a class="fa fa-envelope grey-text text-lighten-3" href="https://github.com/ProblematicDude"></a></li>
                </ul>
            </div>
        </div>
    </div>
