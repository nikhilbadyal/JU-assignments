...
//            System.out.println("Sending request to server");
            ...
            try {
                ...
                while (fTPServerResponse.equals("")){
                ...
                switch (fTPCommand) {
                    ...
                    case LIST:
                        if (fTPServerResponse.startsWith("150")) {
                            ...
                            System.out.println(fTPServerResponse);
//                            System.out.println(fTPServerResponse+" is the response");
                            System.out.flush();
                        ...
                        //        controlSocketIn.
//                                System.out.println("Response from server is "+fTPServerResponse);
                            }
                        }
                    ...
                    case STOR:
                        try{
                            ...
                            System.out.println("Please run EPSV first");
                            controlSocketOut.flush();
                        //    e.printStackTrace();
                        }
                        break;
                }
